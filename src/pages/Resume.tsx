...
const Resume = () => {
  ...
  const projects = [
    {
      ...
      subtitle: "HRIS System including request (payroll, attendance...), tracking (time in/out), compliance, employee request(s), information dissemination (notifications, events, chatbot)",
    ...
    },
    {
      ...
      subtitle: "Leasing management software including dashboard (agent, landlord and admin), asset management, real-time tracking, prospect/tenant sales workflow, agent tracking, sales marketing prospect tracking",
    ...
    },
    {
      ...
      subtitle: "Ecommerce Shopify site - created a custom checkout for finding the right fit for client through creating a Shopify App, created custom landing page and custom product page.",
  ...
  const skills = [
    {
      category: "Design",
      items: ["User Experience", "Design System", "Web Design", "Mobile Design", "Wireframing", "Prototyping"],
    },
    {
      category: "Development",
      items: ["React JS", "Figma", "Next JS", "Laravel/PHP", "Shopify", "JS", "HTML", "CSS", "jQuery"],
    },
    {
      category: "Advanced",
      items: ["Chakra UI", "Material UI", "Framer", "DB", "Databases", "Docker"],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-resume-dark">
      ...
      <footer className="bg-resume-dark py-6 border-t border-resume-primary/20">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Jerquin Bayudo. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
